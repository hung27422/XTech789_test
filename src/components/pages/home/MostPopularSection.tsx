...
function MostPopularSection() {
  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-6 md:px-10 w-full bg-[#f3f7f8] lg:p-4">
        <div className="md:col-span-5 lg:col-span-3 relative">
          <Image
            ...
            priority
            alt="Spiral Arrow"
            className="h-[300px] md:h-[400px] lg:h-[600px] w-full object-cover rounded-md"
          />
          <div className="flex flex-col absolute inset-0 pl-4 mt-4">
            <span className="text-3xl w-[200px] lg:w-[120px]">
        ...
        {/* Menu */}
        <div className="flex flex-col md:col-span-7 lg:col-span-9 md:mt-4">
          <div className="flex justify-center">
            {menuMostPopular.map((item) => (
              <span
                onClick={() => setToggled(item.id)}
                key={item.id}
                className={`text-lg md:text-xl lg:text-2xl  px-4 py-2 border cursor-pointer hover:bg-gray-200 mx-1 ${
                  toggled === item.id
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-2 bg-[#f3f2ee] gap-6 p-10">
        ...
        <div className="flex flex-col col-span-1 items-start justify-center p-8">
          ...
          <div className="bg-primary text-white text-lg lg:text-xl font-semibold px-4 md:px-6 py-3 rounded-md mt-8 cursor-pointer transition-colors hover:!bg-amber-500">
            SHOP NOW
          </div>
        </div>
      </div>
